...
class _FinishBookScreenState extends State<FinishBookScreen> {
  ...
  final List<String> titleList = ['소년이 온다', '책 제목', '책 제목'];
  final List<String> authorList = ['한강', '저자 명', '저자 명'];
  final List<String> percentList = ['100%', '100%', '100%'];
  final List<String> lastReadList = ['24시간 전', '24시간 전', '24시간 전'];
