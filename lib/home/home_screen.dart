...
class _HomeScreenState extends State<HomeScreen> {
  final List<String> titleList = [
    '데미안', '종의 기원', '소년이 온다', '이기적 유전자', '싯다르타',
    '침묵의 봄', '이방인', '아몬드', '눈먼 자들의 도시'
  ];
  ...
  final Map<String, Map<String, String>> bookInfoMap = {
    ...
    '종의 기원': {'author': '정유정', 'image': 'assets/images/b_jong.png'},
    '이기적 유전자': {'author': '리처드 도킨스', 'image': 'assets/images/b_gene.png'},
    '싯다르타': {'author': '헤르만 헤세', 'image': 'assets/images/b_shitda.png'},
    '침묵의 봄': {'author': '레이첼 카슨', 'image': 'assets/images/b_spring.png'},
